...
public class ReviewJFrame extends javax.swing.JFrame {
    ...
    private ConsumerProfileJPanel consumerpanel;
    private OrderDetailJPanel detailPanel;
    /**
     * Creates new form ReviewJFrame
     */
    public ReviewJFrame(EcoSystem system, OrderRequest order, Outlet outlet, ConsumerProfileJPanel consumerpanel, 
            OrderDetailJPanel orderdetPanel, String pattern) {
        initComponents();
        this.system= system;
        this.orderReq = order;
        this.outlet = outlet;
        this.consumerpanel = consumerpanel;
        this.detailPanel = orderdetPanel;
        ...
        if(pattern.equalsIgnoreCase("View")) {
            ...
            this.rateSpinner.setValue(order.getReview().getRating());
            this.commentTextArea.setText(order.getReview().getMessage());
        }
        this.merchantTextField.setText(outlet.getOrg_name());
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        this.dispose();
        this.consumerpanel.populateTable();
