...
public class OrderInventoryConfirmationJPanel extends javax.swing.JPanel {
    ...
    private InventoryItemRequest ir;
    ...
    public OrderInventoryConfirmationJPanel(InventoryItemRequest ir) {
        initComponents();
        this.ir = ir;

        this.employeeAccount = (EmployeeAccount)ir.getAccount();
        this.restaurantLabel.setText(ir.getEnterprise().getOrg_name());
        this.orderNumLabel.setText(ir.getInventoryOrderId());
        this.nameLabel.setText(ir.getDeliveryName());
        this.addressLabel.setText(ir.getDeliveryAddress());
        this.phoneLabel.setText(ir.getDeliveryPhone());
    ...
    private void populateTable2() {
        ...
        dtm.setRowCount(0);
        for (CommodityOrder itemr : ir.getInventorOrder()) {
            Object row[] = new Object[3];
            row[0] = itemr;
            row[1] = itemr.getQuantity();
            row[2] = itemr.getTotalPrice();
            dtm.addRow(row);
        }
        BigDecimal bd = new BigDecimal(this.ir.getAmount());
    ...
    private void initComponents() {
        ...
        restaurantLabel1.setText("Inventory:");
