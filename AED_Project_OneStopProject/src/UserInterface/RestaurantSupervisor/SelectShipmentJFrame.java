 ...
 * @author rutu
 */
public class SelectShipmentJFrame extends javax.swing.JFrame {
     ...
     */
    public SelectShipmentJFrame(EcoSystem system, JPanel panel, Network net,
            Outlet shop, OrderRequest request) {
        initComponents();
        this.system = system;
        this.net = net;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (deliveryList.getSelectedValue() != null) {
            ShipmentCompany de = (ShipmentCompany) deliveryList.getSelectedValue();
            request.setCompany(de);
            request.setStatus(WorkRequest.StatusEnum.Ready);
            ShipmentRequest dr = new ShipmentRequest(shop, null, request);
...
//            java.util.logging.Logger.getLogger(SelectShipmentJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new SelectShipmentJFrame().setVisible(true);
//            }
//        });
//    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JList<Model.Enterprise.Delivery.ShipmentCompany> deliveryList;
