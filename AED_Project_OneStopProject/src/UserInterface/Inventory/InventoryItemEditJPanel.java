 ...
 * @author rutu
 */
public class InventoryItemEditJPanel extends javax.swing.JPanel {
     ...
     */
    public InventoryItemEditJPanel(EcoSystem system, JPanel panel, JPanel detailPanel, Commodity commodity) {
        initComponents();
        this.system = system;
        this.panel = panel;
    ...
    private void setInfo() {
        nameTextField.setText(commodity.getCom_name());
        priceTextField.setText(commodity.getCom_price() + "");
    }
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        try {
            ...
            this.commodity.setCom_name(name);
            BigDecimal bd = new BigDecimal(price);
            this.commodity.setCom_price(bd.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
            ...
            if (panel instanceof InventoryManagerMainJPanel) {
                ...
                p.populateInventoryItemTable();
                JOptionPane.showMessageDialog(null, "item Information modified successfully");
            }
        } catch (Exception e) {
