...
public class InventoryCreateJPanel extends javax.swing.JPanel {
     ...
     */
    public InventoryCreateJPanel(EcoSystem system, JPanel panel, JPanel createPanel, Outlet outlet) {
        initComponents();
        this.system = system;
        this.panel = panel;
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        try {
            ...
            if (outlet.getOut_type().equals(OutletType.Inventory)) {
                Inventory inventory = (Inventory) outlet;
                InventoryItem inven = new InventoryItem(inventory, name, price);
                inventory.addInventoryItem(inven);
