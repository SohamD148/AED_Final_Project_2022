...
public class SystemAdminMainJPanel extends javax.swing.JPanel {
    ...
    private ArrayList<UserAccount> getAllConsumerAccount(ArrayList<UserAccount> list) {
    ...
    public ArrayList<ConsumerAccount> toConsumerAccounts(ArrayList<UserAccount> list) {
        ...
        for (UserAccount ua : getAllConsumerAccount(list)) {
            ConsumerAccount ea = (ConsumerAccount) ua;
            result.add(ea);
        }
        return result;
    }
    ...
    public void populateTable(ArrayList<UserAccount> list) {
        ...
        dtm.setRowCount(0);
        for (UserAccount u : getAllConsumerAccount(list)) {
            ConsumerAccount c = (ConsumerAccount) u;
            Object row[] = new Object[5];
            row[0] = c;
            row[1] = c.getConsumer().getFullname();
            row[2] = c.getConsumer().getEmail();
            row[3] = c.getConsumer().getMobile_no();
    ...
    private void initComponents() {
        ...
        manageNetworkPanel.setBackground(new java.awt.Color(255, 153, 153));
        ...
        manageCustomerPanel.setBackground(new java.awt.Color(255, 153, 153));
    ...
    private void editEnterpriseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editEnterpriseButtonActionPerformed
        if (enterpriseList.getSelectedValue() != null) {
            SystemAdminMainJFrame f = new SystemAdminMainJFrame(system, this.selectedNetwork,
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (index >= 0) {
            ...
            SystemAdminMainJFrame f = new SystemAdminMainJFrame(system, null,
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CreateConsumerJFrame f = new CreateConsumerJFrame(system, this);
        f.setLocationRelativeTo(null);
        f.setVisible(true);
    ...
    private void allButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allButton1ActionPerformed
        Comparator<ConsumerAccount> comp = new Comparator<ConsumerAccount>() {

            @Override
            public int compare(ConsumerAccount o1, ConsumerAccount o2) {
                return Double.compare(o2.getTotalPurchased(), o1.getTotalPurchased());
            }
            
        };
        ArrayList<ConsumerAccount> list = toConsumerAccounts(getAllConsumerAccount(system.
                getUserAccountDirectory().getUserAccountDirectory()));
        Collections.sort(list, comp);
        ArrayList<UserAccount> result = new ArrayList<>();
        for (ConsumerAccount c : list) {
